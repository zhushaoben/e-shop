...
public class UserDomain {
  ...
  public UserDomain(String id, String username, String name, String password, String address,
  ...
  public static UserDomain buildMapper(User obj) {
    UserDomain mapper = new UserDomain();
    mapper.id=obj.getId();
  ...
  public static UserTo convert(User from, UserTo to) {
    if (from == null) return to;
    if (to == null) to = new UserTo();
    to.setId(from.getId());
  ...
  public static User convert(UserTo from, User to) {
    if (from == null) return to;
    if (to == null) to = new User();
    to.setId(from.getId());
    to.setUsername(from.getUsername());
    to.setName(from.getName());
    to.setPassword(from.getPassword());
