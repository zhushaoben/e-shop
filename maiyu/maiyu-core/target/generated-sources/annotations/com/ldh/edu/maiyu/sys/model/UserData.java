...
public class UserData {
  ...
  public UserData(String id, String username, String name, String password, String address,
  ...
  public static UserData buildMapper(User obj) {
    UserData mapper = new UserData();
    mapper.id=obj.getId();
  ...
  public static UserDo convert(User from, UserDo to) {
    if (from == null) return to;
    if (to == null) to = new UserDo();
    to.setId(from.getId());
  ...
  public static User convert(UserDo from, User to) {
    if (from == null) return to;
