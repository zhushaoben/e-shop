...
public class CartDomain {
  ...
  public CartDomain(String id, String userId, String productId, Integer number) {
    this.id=id;
    this.userId=userId;
  ...
  public static CartDomain buildMapper(Cart obj) {
    CartDomain mapper = new CartDomain();
    mapper.id=obj.getId();
  ...
  public static CartTo convert(Cart from, CartTo to) {
    if (from == null) return to;
    if (to == null) to = new CartTo();
    to.setId(from.getId());
  ...
  public static Cart convert(CartTo from, Cart to) {
    if (from == null) return to;
