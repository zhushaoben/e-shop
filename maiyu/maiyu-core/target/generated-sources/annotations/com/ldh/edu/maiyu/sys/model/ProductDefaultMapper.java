...
public class ProductDefaultMapper {
  public String id;
  ...
  public ProductDefaultMapper() {
  }

  public ProductDefaultMapper(String id, String busmanId, BigDecimal price, String name,
      Integer stock, Integer sell, String imgPath, String details, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static ProductDefaultMapper buildMapper(Product obj) {
    ProductDefaultMapper mapper = new ProductDefaultMapper();
    mapper.id=obj.getId();
