...
public class ProductData {
  ...
  public ProductData(String id, String busmanId, BigDecimal price, String name, Integer stock,
  ...
  public static ProductData buildMapper(Product obj) {
    ProductData mapper = new ProductData();
    mapper.id=obj.getId();
  ...
  public static ProductDo convert(Product from, ProductDo to) {
    if (from == null) return to;
    if (to == null) to = new ProductDo();
    to.setId(from.getId());
  ...
  public static Product convert(ProductDo from, Product to) {
    if (from == null) return to;
