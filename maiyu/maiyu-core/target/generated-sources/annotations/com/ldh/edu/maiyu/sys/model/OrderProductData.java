...
public class OrderProductData {
  ...
  public OrderProductData(String id, String productId, String orderId, Integer number) {
    this.id=id;
  ...
  public static OrderProductData buildMapper(OrderProduct obj) {
    OrderProductData mapper = new OrderProductData();
    mapper.id=obj.getId();
  ...
  public static OrderProductDo convert(OrderProduct from, OrderProductDo to) {
    if (from == null) return to;
    if (to == null) to = new OrderProductDo();
    to.setId(from.getId());
  ...
  public static OrderProduct convert(OrderProductDo from, OrderProduct to) {
    if (from == null) return to;
