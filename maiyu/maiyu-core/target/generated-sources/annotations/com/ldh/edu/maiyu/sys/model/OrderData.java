...
public class OrderData {
  ...
  public OrderData(String id, String customerId, String busmanId, String address,
  ...
  public static OrderData buildMapper(Order obj) {
    OrderData mapper = new OrderData();
    mapper.id=obj.getId();
  ...
  public static OrderDo convert(Order from, OrderDo to) {
    if (from == null) return to;
    if (to == null) to = new OrderDo();
    to.setId(from.getId());
  ...
  public static Order convert(OrderDo from, Order to) {
    if (from == null) return to;
